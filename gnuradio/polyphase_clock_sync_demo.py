...
# Title: qpsk_constellation
# Author: Tomasz Sokołowski
...
class polyphase_clock_sync_demo(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "qpsk_constellation")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("qpsk_constellation")
        ...
        self.settings = Qt.QSettings("GNU Radio", "polyphase_clock_sync_demo")
        ...
        self.rrc_filter_taps = rrc_filter_taps = firdes.root_raised_cosine(1.0, samp_rate,samp_rate/sps, 0.35, 10*sps)
        ...
        self.digital_pfb_clock_sync_xxx_0 = digital.pfb_clock_sync_ccf(2, 2*3.14/100, rrc_filter_taps, 32, 0, 1.5, 1)
...
def main(top_block_cls=polyphase_clock_sync_demo, options=None):
